        ...
        <basic-area>
            ...
            <div>
                ...
                >
                    ...
                    <vxe-table-column field="name" title="减速机分类" min-width="100"></vxe-table-column>
...
<script>
    ...
    import { getReductionCategoryList } from "@/api/reductionCategory";

    export default {
        name: "reduction-category-list",
        ...
        data(){
            return {
                ...
                getList: getReductionCategoryList,
            }
        },
        ...
        methods: {
            ...
            showInfo(row){
                this.$router.push({
                    path: "/reduction-category/reduction-category-info/" + row.id
                });
            },
            ...
            edit(row){
                this.$router.push({
                    path: "/reduction-category/reduction-category-edit/" + row.id
                });
            },
        }
    }
