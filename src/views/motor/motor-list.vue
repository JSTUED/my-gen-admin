        ...
        <basic-area>
            ...
            <div>
                ...
                >
                    ...
                    <vxe-table-column field="name" title="电机型号" min-width="100"></vxe-table-column>
                    <vxe-table-column field="motorCategoryName" title="品牌" min-width="100"></vxe-table-column>
...
<script>
    ...
    import { getMotorList } from "@/api/motor";
